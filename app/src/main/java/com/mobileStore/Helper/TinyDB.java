...
public class TinyDB {
    ...
    public ArrayList<PhoneDomain> getListObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<PhoneDomain> playerList =  new ArrayList<PhoneDomain>();

        for(String jObjString : objStrings){
            PhoneDomain player  = gson.fromJson(jObjString,  PhoneDomain.class);
    ...
    public void putListObject(String key, ArrayList<PhoneDomain> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(PhoneDomain player: playerList){
